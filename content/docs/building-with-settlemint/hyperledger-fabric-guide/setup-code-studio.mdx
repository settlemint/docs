...
full-featured web-based IDE, pre-configured for blockchain development using
tools like Hardhat, Foundry, and The Graph. Once added, you can use built-in
tasks to build, test and deploy chaincodes, all within the same environment.
...
testing, deployment, and indexing of chaincodes and subgraphs, all within a
unified environment.
...
## Fabric__abbr_9vb9l2s75__project structure
...
## Code studio__abbr_q7obc13hg__task manager for fabric
