---
title: "How to Set Up Enterprise Off-Chain Database with Hasura"
description: Complete guide to configuring Hasura backend-as-a-service for enterprise blockchain applications with PostgreSQL, GraphQL APIs, and compliance features
---
