...
names, invite more members, or delete resources when needed. You can also create
and manage applications using the SDK CLI or SDK JS if you prefer to work
programmatically.
