...
![Portal REST - POST /wallets request](../../../img/building-with-settlemint/portal-wallets-post.png)
...
![HD wallet unique name (keyVaultId)](../../../img/building-with-settlemint/hd-wallet-unique-name.png)
...
![User wallets list showing new wallet](../../../img/building-with-settlemint/user-wallets-list.png)
