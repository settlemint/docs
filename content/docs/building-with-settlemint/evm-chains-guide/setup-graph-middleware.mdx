...
## Subgraph folder structure in code studio__abbr_755tkfru5__
...
### Run codegen script using the task manager of the__abbr_8vzvriqkg__

![Graph Codegen](../../../img/building-with-settlemint/graph-codegen.png)

### Run graph build script using the task manager of the__abbr_xn8eyzesv__

![Graph Build](../../../img/building-with-settlemint/graph-build.png)

### Run graph deploy script using the task manager of the__abbr_n1uj3xanw__
