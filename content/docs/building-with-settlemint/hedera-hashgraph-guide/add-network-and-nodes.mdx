...
[create application](/building-with-settlemint/evm-chains-guide/create-an-application) guide
first.
...
For reference, see the full list of supported networks [here](/platform-components/blockchain-infrastructure/network-manager#supported-blockchain-network-protocols).
