...
This is of course on top of the [application access tokens](/building-with-settlemint/application-access-tokens) and [personal access tokens](/building-with-settlemint/personal-access-tokens) in the platform you can use to close off access to the entire API.
