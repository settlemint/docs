...
description:
  A comprehensive technical and functional guide to understanding cryptocurrencies, their ecosystem, architecture, and use cases
pageTitle: Cryptocurrency tokens - Utility and governance tokens
tags: [cryptocurrency, utility-token, governance, use-case]
---
