...
pageTitle: XvP atomic settlements - Delivery versus payment
tags: [xvp, settlement, atomic, dvp, pvp]
---
...
![XvP Settlement list](/images/btp/xvp-settlement/list.png)
...
1. **Settlement flows**: Configure two or more flows, where each flow specifies:
   ...
   ![XvP Settlement flows](/images/btp/xvp-settlement/flows.png)
...
3. **Auto-execute**: Whether to automatically execute the settlement on final
   ...
   ![XvP Settlement configuration](/images/btp/xvp-settlement/configuration.png)

Lastly, review the settlement details and submit the transaction to deploy a new
XvP Settlement contract.

![XvP Settlement summary](/images/btp/xvp-settlement/summary.png)
...
![XvP Settlement approve](/images/btp/xvp-settlement/approve.png)
...
![XvP Settlement execute](/images/btp/xvp-settlement/execute.png)
...
![XvP Settlement cancel](/images/btp/xvp-settlement/cancel.png)
