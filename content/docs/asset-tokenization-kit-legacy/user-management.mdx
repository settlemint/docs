...
pageTitle: User Management & KYC - User lifecycle and compliance
tags: [user-management, kyc, aml, compliance, rbac, identity]
---
...
![Users list](/images/btp/application-kits/user-list.png)
...
![Users holdings](/images/btp/application-kits/user-holding.png)
...
![Users events](/images/btp/application-kits/user-event-logs.png)
