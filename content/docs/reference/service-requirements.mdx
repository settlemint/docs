...
<Tabs items={["Blockchain Nodes", "Smart Contract Sets", "Middleware Services", "Integration Services", "Insights Services", "Custom Deployments", "Storage Services"]}>
  ...
  <Tab value="Integration Services">
    ### Integration Studio
