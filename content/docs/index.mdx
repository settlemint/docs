...
<a
  ...
  className="block no-underline rounded-xl px-3 py-0 shadow-sm bg-blue-200 dark:bg-blue-950 text-slate-800 dark:text-white hover:shadow-md transition"
>
...
<table className="table-auto text-sm leading-none w-full">
  <tbody>
    <tr>
      <td
        colSpan="3"
        className="bg-blue-200 dark:bg-blue-950 text-center py-2 pl-3 text-[15px] font-semibold text-slate-800 dark:text-white border-b border-blue-300 dark:border-blue-900"
      >
