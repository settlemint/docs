...
<div style={{ display: 'flex', alignItems: 'flex-start', gap: '1.5rem' }}>
  <div style={{ flex: '0 0 40%' }}>
    ![Settlemint](/images/btp/using-the-platform/on-prem.webp)
  </div>
...
<figure>
  ![High-level view of SettleMint components operating within an enterprise-controlled environment](/images/btp/launching-the-platform/self-hosted-architecture.svg)
  <figcaption>
