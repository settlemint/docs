...
pageTitle: Integration Studio - Visual workflow builder
tags: [integration-studio, workflows, api, evm]
---
...
![Add Integration Studio](/images/btp/building-with-settlemint/add-integration-studio.png)
...
![Integration Studio Flows](/images/btp/building-with-settlemint/integration-studio-flows.png)
...
![Integration Studio Endpoint](/images/btp/building-with-settlemint/integration-studio-endpoint.png)
...
![Integration Studio Modules](/images/btp/building-with-settlemint/integration-studio-modules.png)
