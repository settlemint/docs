...
pageTitle: Deploy Contracts - Smart contract deployment
tags: [deployment, smart-contracts, subgraphs, evm]
---
...
<div style={{ flex: "1", paddingLeft: "1rem" }}>
  <ul>
    ...
    ![Settlemint](/images/btp/building-with-settlemint/task-manager.png)
...
file.
![Foundry Compile Smart Contract](/images/btp/building-with-settlemint/foundry-build.png)
...
![Hardhat Compile Smart Contract](/images/btp/building-with-settlemint/hardhat-build.png)
...
![Foundry Test Pass](/images/btp/building-with-settlemint/foundry-test.png)
...
![Hardhat Test Pass](/images/btp/building-with-settlemint/hardhat-test.png)
...
![Start Hardhat Local Network](/images/btp/building-with-settlemint/hardhat-start-test-network.png)

Deploy to test network
![Hardhat Deploy Local](/images/btp/building-with-settlemint/hardhat-deploy-on-test-network.png)
...
![Select node to deploy](/images/btp/building-with-settlemint/select-deployment-script.png)
...
![Contract Deployed](/images/btp/building-with-settlemint/contract-deployed-cli.png)
