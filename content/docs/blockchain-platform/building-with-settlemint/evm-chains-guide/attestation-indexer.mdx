...
description:
  How to work with ethereum attestation indexer
pageTitle: Attestation Indexer - Ethereum attestation service
tags: [attestation, indexer, ethereum, evm]
---
...
![Add attestation indexer](/images/btp/building-with-settlemint/add-attestation-indexer.png)
...
![Configure attestation indexer](/images/btp/building-with-settlemint/configure-attestation-indexer.png)
