...
pageTitle: Graph Middleware - The Graph middleware setup
tags: [graph-middleware, the-graph, setup, evm]
---
...
![Add Graph Middleware](/images/btp/building-with-settlemint/add-graph-middleware.png)

<include>../../_snippets/create-middleware.mdx</include>

### Manage middleware

<include>../../_snippets/manage-middleware.mdx</include>
...
![Graph Codegen](/images/btp/building-with-settlemint/graph-codegen.png)

### Run graph build script using the task manager of the ide

![Graph Build](/images/btp/building-with-settlemint/graph-build.png)

### Run graph deploy script using the task manager of the ide

![Graph Deploy](/images/btp/building-with-settlemint/graph-deploy.png)
...
![Graph Query Profile](/images/btp/building-with-settlemint/graph-query-profile.png)

Or we can query to return all entries
![Graph Query multiple Profiles](/images/btp/building-with-settlemint/graph-query-profiles.png)


<Callout type="success" title="Congratulations!">
You have successfully configured graph middleware and deployed subgraphs to enable smart contract indexing. With this you have both read and write middleware for your smart contracts.
