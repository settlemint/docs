...
pageTitle: Code Studio Setup - Development IDE configuration
tags: [code-studio, ide, setup, development]
---
...
![Add Code Studio](/images/btp/building-with-settlemint/add-code-studio.png)
...
![Code Studio Web IDE](/images/btp/building-with-settlemint/code-studio-ide.png)
...
<Tabs items={['SDK CLI', 'Platform UI', 'SDK JS']}>
  <Tab value="Platform UI">
    <Steps>
      ...
      ![Dev tools](/images/btp/smart-contract-sets/empty-dev-tools.png)

      ### Select code studio
      Select **code studio** as the dev tool type.

      ![Select Code Studio](/images/btp/smart-contract-sets/select-code-studio.png)

      ### Choose smart contract set
      Then choose **smart contract set**.

      ![Select Smart Contract Set](/images/btp/smart-contract-sets/select-smart-contract-set.png)

      ### Pick a template
      Pick a **template**; the code studio will load with your chosen smart contract template.

      ![Select Template](/images/btp/smart-contract-sets/select-template.png)

      ### Enter details
      Click **continue** to enter details such as the dev tool name, user, and deployment plan.

      ![Click Continue](/images/btp/smart-contract-sets/click-continue.png)
