...
description:
  Complete guide to configuring Hasura backend-as-a-service for enterprise blockchain applications with PostgreSQL, GraphQL APIs, and compliance features
pageTitle: Offchain Database - Hasura database for Fabric
tags: [hyperledger-fabric, hasura, database, setup]
---
...
![Add Hasura](/images/btp/building-with-settlemint/add-hasura.png)
...
![Hasura Connect](/images/btp/building-with-settlemint/hasura-connect.png)
...
You have successfully configured Hasura backend-as-a-service layer with the off-chain database of your choice.
