...
pageTitle: Network & Nodes Setup - Hyperledger Fabric network deployment
tags: [hyperledger-fabric, network, nodes, setup, deployment]
---
...
<Cards>
  <Card title="Deployment Timeline" description="Typical enterprise deployment: 15-30 minutes for initial network setup, with additional time for consortium member onboarding and compliance configurations." />
</Cards>
## Prerequisites
...
![Select Network](/images/btp/building-with-settlemint/select-network-fabric.png)
...
![Add Node](/images/btp/building-with-settlemint/add-fabric-node-ui.png)
