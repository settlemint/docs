...
pageTitle: Code Studio Setup - Development IDE for Fabric
tags: [hyperledger-fabric, code-studio, ide, setup]
---
...
![Add Code Studio](/images/btp/building-with-settlemint/add-fabric-ide.png)
...
![Fabric Chaincode IDE](/images/btp/building-with-settlemint/chaincode-ide.png)
...
You have successfully deployed the code studio. From here you can proceed for development and deployment of chaincodes.
</Callout>
