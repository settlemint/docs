...
pageTitle: FabConnect Middleware - Fabric REST API setup
tags: [hyperledger-fabric, fabconnect, middleware, api]
---
...
![Add FabConnect](/images/btp/building-with-settlemint/add-fabconnect.png)
...
## ![fabconnect ui](/images/btp/building-with-settlemint/fabconnect-ui.png)
