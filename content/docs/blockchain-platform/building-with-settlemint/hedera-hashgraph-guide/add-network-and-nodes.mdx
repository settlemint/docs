...
pageTitle: Add Network and nodes - Hedera network setup
tags: [hedera, network, nodes, setup]
---
...
You have successfully built the blockchain infrastructure layer for your application. From here you can proceed for creating or setting up private keys for transaction signer and user wallets.
</Callout>
