...
pageTitle: Support - Technical assistance and guidance
tags: [support, help, assistance, documentation]
---
...
<div style={{ display: 'flex', alignItems: 'flex-start', gap: '1.5rem', marginBottom: '2rem' }}>
  <div style={{ flex: '0 0 30%' }}>
    ![SettleMint support](/images/btp/using-the-platform/support.png)
  </div>
...
<Cards>
  <Card title="Technical Support" description="Get help with platform issues, smart contract debugging, and deployment challenges" href="mailto:support@settlemint.com" />
  <Card title="Enterprise Support" description="Dedicated account management and priority assistance for enterprise clients" href="/docs/support/slas" />
  <Card title="Documentation" description="Comprehensive guides, tutorials, and API references for self-service support" href="/docs" />
  <Card title="Community" description="Connect with other developers and share knowledge in our community forums" href="https://community.settlemint.com" />
</Cards>
