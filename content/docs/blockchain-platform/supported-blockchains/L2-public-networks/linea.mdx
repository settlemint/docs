...
title: Linea
description:
  Deploy on Linea, Consensys' zkEVM Layer 2, to combine Ethereum-grade security with low fees and fast confirmations.
pageTitle: Linea - Consensys zkEVM Layer 2
tags: [linea, zkevm, layer-2, ethereum, consensys]
---
...
<Cards>
  <Card title="Linea Mainnet" description="Production zkEVM network secured by Ethereum. Ideal for consumer-scale applications needing low fees, rapid finality, and seamless MetaMask adoption." />
  <Card title="Linea Sepolia" description="Go-to testnet for staging deployments with faucet availability, L2 data availability testing, and configurable throughput scenarios." />
</Cards>
