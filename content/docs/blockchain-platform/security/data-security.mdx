...
pageTitle: Data Security - Enterprise blockchain data protection
tags: [security, data-protection, encryption, key-management]
---
...
<Cards>
  <Card title="Encryption & Key Management" description="End-to-end encryption with HSM-backed key management and rotation" />
  <Card title="Backup & Recovery" description="Automated backup systems with point-in-time recovery and disaster recovery" />
  <Card title="Data Governance" description="Compliance-ready data classification, retention, and deletion policies" />
  <Card title="Access Control" description="Zero-trust data access with multi-factor authentication and audit trails" />
</Cards>
