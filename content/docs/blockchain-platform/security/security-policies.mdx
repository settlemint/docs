...
pageTitle: Security Policies - Enterprise blockchain security governance
...
<Cards>
  <Card title="Data Protection & Privacy" description="GDPR, CCPA, and industry-specific data protection policies" />
  <Card title="Access Control & Identity" description="Zero-trust access policies with multi-factor authentication requirements" />
  <Card title="Incident Response & Recovery" description="24/7 incident response policies with blockchain-specific procedures" />
  <Card title="Third-Party Risk Management" description="Vendor security assessment and supply chain risk policies" />
</Cards>
