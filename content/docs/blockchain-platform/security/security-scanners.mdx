...
pageTitle: Security Scanners - Vulnerability detection and scanning
tags: [security, scanning, sast, dast, devsecops]
---
...
<Cards>
  <Card title="Static Application Security Testing (SAST)" description="Source code analysis for security vulnerabilities and compliance violations" />
  <Card title="Dynamic Application Security Testing (DAST)" description="Runtime testing of web applications and blockchain networks" />
  <Card title="Container & Infrastructure Security" description="Image scanning, configuration analysis, and runtime protection" />
  <Card title="Dependency & Supply Chain Security" description="Third-party component scanning and software bill of materials" />
</Cards>
