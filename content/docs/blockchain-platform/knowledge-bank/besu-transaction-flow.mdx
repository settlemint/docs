...
description:
  Hyperledger Besu transaction lifecycle from key generation through execution, validation, and block finalization
pageTitle: Besu transaction cycle - EVM transaction lifecycle
tags: [hyperledger-besu, transaction-flow, evm, blockchain]
---
