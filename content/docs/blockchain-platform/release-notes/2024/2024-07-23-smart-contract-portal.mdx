...
description: "Middleware that creates an easy-to-use API on top of smart contracts, supporting all EVM-compatible chains with GraphQL optimization and simplified integration."
author: "SettleMint"
date: 2024-07-23
---
...
![Changelog Image](/images/release-notes/smart-contract-set-portal.png)
