...
description: "Support for Hedera Hashgraph network, a public distributed ledger using the Hashgraph consensus algorithm, providing high throughput, low latency, and fair transaction ordering for enterprise applications."
author: "SettleMint"
date: 2024-06-27
---
...
![Changelog Image](/images/release-notes/hashgraph-hedera.png)
