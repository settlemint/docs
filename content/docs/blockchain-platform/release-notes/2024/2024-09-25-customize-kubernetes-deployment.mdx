...
description: "Intuitive UI for managing Kubernetes deployment settings including annotations, labels, tolerations, affinity, and node selectors to optimize infrastructure integration and performance."
author: "SettleMint"
date: 2024-09-25
---
...
![Changelog Image](/images/release-notes/customize-kubernetes-deployment-settings.png)
