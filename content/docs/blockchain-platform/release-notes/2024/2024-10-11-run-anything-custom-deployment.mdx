...
description: "Revolutionary feature allowing users to deploy custom-built front-end and web technologies while leveraging SettleMint's robust blockchain backend with flexible application design."
author: "SettleMint"
date: 2024-10-11
---
...
![Changelog Image](/images/release-notes/run-anything-as-a-custom-deployment.png)
