...
description: "Sophisticated account management and identity masking solution using Hierarchical Deterministic (HD) wallets for enhanced privacy and security."
author: "SettleMint"
date: 2024-09-27
---
...
![Changelog Image](/images/release-notes/user-wallet-manager.png)
...
linked, but also streamlines the management of keys. Users can efficiently
create multiple child wallets under a single parent wallet, making it easy to
