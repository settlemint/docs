...
<Cards>
  <Card title="Financial Services" description="- Challenge: Manual verification processes cost $48M annually for large banks - Solution: Automated attestation system with blockchain verification - ROI: 75% reduction in compliance staff, 90% faster customer onboarding" />
  
  <Card title="Healthcare Organizations" description="- Challenge: Medical credential fraud costs healthcare $58B annually - Solution: Immutable professional licensing and certification records - ROI: 99% fraud reduction, 60% faster credential verification" />
  
  <Card title="Supply Chain Companies" description="- Challenge: Counterfeit goods account for $509B in global losses - Solution: End-to-end product attestation and provenance tracking - ROI: 85% reduction in counterfeit incidents, 40% increase in consumer trust" />
  
  <Card title="Educational Institutions" description="- Challenge: Academic fraud affects 20% of job applications globally - Solution: Blockchain-based diploma and certification verification - ROI: 95% fraud elimination, instant credential verification" />
</Cards>
