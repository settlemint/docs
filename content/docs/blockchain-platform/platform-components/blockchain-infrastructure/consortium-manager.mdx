...
description: Complete guide to building permissioned blockchain networks with multiple organizations. Learn to invite partners, set permissions, and manage enterprise consortium governance with SettleMint's consortium manager.
---
...
![Invite Member to Org](/images/btp/platfrom-components/invite-member-to-org.png)
...
![Invite Organization](/images/btp/platfrom-components/invite-org-to-network.png)
...
![Invite Organization User](/images/btp/platfrom-components/invite-user-to-network.png)
