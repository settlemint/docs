...
![Transaction Signer](/images/btp/platfrom-components/transaction-signer.png)
...
![Transaction Signer Keys Mapping](/images/btp/platfrom-components/signer-key-mapping.png)
