...
SettleMint supports the Ethereum **Mainnet**, the **Sepolia Testnet**, and
the **Holesky Testnet**.
...
transaction fee, payable in the native coin ETH. The Testnets are instances of
the blockchain to be used for testing and experimentation. There are also coins
used in the Testnets but they have no value, so there is no risk of real funds.

You can consider the Testnets as prototypes and the Mainnet as the official
...
#### Holesky Testnet
Holesky is the new long-term testnet for Ethereum, designed to replace Goerli. 
It was launched in September 2023 and is intended to be a stable, long-running 
testnet for protocol development, staking tests, and infrastructure testing.

- **Chain ID**: 17000
- **Purpose**: Long-term testnet for protocol-level testing, staking, and infrastructure
- **Features**: 
  - Larger validator set compared to other testnets
  - More closely mimics mainnet conditions
  - Designed for long-term stability and support

#### Sepolia Testnet
Sepolia is a proof-of-stake testnet for application developers. It uses a 
permissioned validator set and is relatively new, making it quick to sync.

- **Chain ID**: 11155111
- **Purpose**: Application development and testing
- **Features**: Quick sync times, stable environment for dApp testing
...
implemented on the Ethereum mainnet chain as well as the Sepolia and Holesky
testnets.
