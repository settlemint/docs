...
Read more about how to set this up using the SDK here:
[Transaction Monitoring & Alerting](/platform-components/middleware-and-api-layer/transaction-monitoring-and-alerting)
