---
title: "How do I connect AI agents to blockchain infrastructure?"
description: Complete guide to Model Context Protocol (MCP) integration with SettleMint. Learn to build AI-powered blockchain applications, automate smart contract management, and create intelligent dApps with real-time blockchain data access.
---
