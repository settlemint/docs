...
For detailed instructions, visit the [Smart Contract Sets Documentation](/building-with-settlemint/dev-tools/code-studio/smart-contract-sets/smart-contract-sets).
