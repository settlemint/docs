...
<Tabs items={["1. Requirements", "2. Prerequisites", "3. Installation"]}>
  <Tab value="1. Requirements">
    ...
    👉 [View Requirements Guide](/docs/launching-the-platform/self-hosted/installation-guide/infrastructure-requirements)
  </Tab>
  ...
  <Tab value="2. Prerequisites">
    ...
    👉 [View Prerequisites Guide](/docs/launching-the-platform/self-hosted/installation-guide/prerequisites/overview)
  </Tab>
...
<Callout type="info">
**Next Step**
Start by reviewing the [Infrastructure Requirements](/docs/launching-the-platform/self-hosted/installation-guide/infrastructure-requirements) to ensure your environment meets all necessary specifications.
</Callout>
