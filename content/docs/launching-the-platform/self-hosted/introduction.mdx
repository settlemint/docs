...
<Callout type="info">
**Next Step**
Start by reviewing the [Infrastructure Requirements](/launching-the-platform/self-hosted/infrastructure-requirements) to ensure your environment meets all necessary specifications.
</Callout>
