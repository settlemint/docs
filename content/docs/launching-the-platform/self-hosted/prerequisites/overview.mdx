...
1. Start with the [Ingress Controller](/launching-the-platform/self-hosted/prerequisites/ingress-controller) setup
2. Follow each prerequisite guide in order
3. Validate your configurations
4. Proceed to [Platform Installation](/launching-the-platform/self-hosted/platform-installation)
