...
<Callout>
For detailed specifications of all available services and their resource requirements, please refer to our [Service Requirements Documentation](/docs/reference/service-requirements).
</Callout>
