...
<Steps>
  ...
  ### Proceed to Domain and TLS Setup
  Continue the installation by [configuring your domain and TLS settings](/documentation/launching-the-platform/self-hosted-onprem/prerequisites/domain-and-tls).
</Steps>
