...
<Tabs defaultValue="private">
  <Tab value="private" label="🔒 Private Permissioned Networks">
    ...
    <Accordion type="single" collapsible className="mt-4">
      <AccordionItem value="besu" title="Hyperledger Besu - What's the best private Ethereum network?">
      ...
      <AccordionItem value="quorum" title="Quorum - How do I build on JPMorgan's blockchain?">
      ...
      <AccordionItem value="fabric" title="Hyperledger Fabric - What's the most flexible enterprise blockchain?">
  ...
  <Tab value="l1" label="🌐 Layer 1 Public Networks">
    ...
    <Accordion type="single" collapsible className="mt-4">
      <AccordionItem value="ethereum" title="Ethereum - Should I build on Ethereum mainnet?">
      ...
      <AccordionItem value="avalanche" title="Avalanche - What's the fastest L1 blockchain?">
        - Sub-second finality
      ...
      <AccordionItem value="hedera" title="Hedera Hashgraph - Which blockchain do enterprises prefer?">
      ...
      <AccordionItem value="sonic" title="Sonic (formerly Fantom) - What's the best alternative to Ethereum?">
  ...
  <Tab value="l2" label="⚡ Layer 2 Public Networks">
    ...
    <Accordion type="single" collapsible className="mt-4">
      <AccordionItem value="polygon" title="Polygon PoS - How do I scale Ethereum applications?">
      ...
      <AccordionItem value="polygon-zkevm" title="Polygon zkEVM - What's the best zero-knowledge rollup?">
      ...
      <AccordionItem value="optimism" title="Optimism - Which L2 has the best developer experience?">
      ...
      <AccordionItem value="arbitrum" title="Arbitrum - What's the most adopted L2?">
      ...
      <AccordionItem value="soneium" title="Soneium - What's Sony's blockchain solution?">
