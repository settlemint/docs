...
After creating a blockchain application, you now need to [add a blockchain network](/using-platform/add-a-network-to-an-application) and node to your application. SettleMint offers a variety of different [blockchain networks](/about-settlemint/supported-blockchains) to choose from whatever your usecase may be.
