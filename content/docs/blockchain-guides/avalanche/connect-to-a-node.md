...
to a node. This section describes how to connect to your Avalanche node.

Once a node has been deployed on an EVM (Ethereum Virtual Machine) compatible
network, such as Avalanche, it can be accessed by different endpoints such as
...
found in the [Avalanche official documentation](https://build.avax.network/).
