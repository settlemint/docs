...
There are different kinds of methods that can be used: ADMIN methods, DEBUG methods, ETH methods etc. The entire list of methods that can be used can be found in the [Besu official documentation](https://besu.hyperledger.org/en/stable/Reference/API-Methods/).
