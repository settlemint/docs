...
<Accordion type="single" collapsible>
  <AccordionItem value="ethereum" title="Ethereum - When is it worth the premium for maximum security and adoption?">
  ...
  <AccordionItem value="layer2" title="Layer 2 Solutions - How to get Ethereum benefits at 100x lower cost?">
  ...
  <AccordionItem value="alternatives" title="Alternative Layer 1s - When do specialized blockchains make sense?">
