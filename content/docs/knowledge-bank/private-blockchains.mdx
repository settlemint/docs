...
<Accordion type="single" collapsible>
  <AccordionItem value="besu" title="Hyperledger Besu - Best for Ethereum-compatible enterprise applications">
  ...
  <AccordionItem value="fabric" title="Hyperledger Fabric - Best for complex B2B consortiums">
  ...
  <AccordionItem value="quorum" title="Quorum - Best for financial services">
  ...
  <AccordionItem value="corda" title="R3 Corda - Best for financial and legal workflows">
