...
<Accordion type="single" collapsible>
  <AccordionItem value="hashing" title="What is cryptographic hashing and why does it secure blockchain?">
  ...
  <AccordionItem value="nonce" title="What is a nonce and how does it prevent double-spending?">
  ...
  <AccordionItem value="keys" title="How do public/private keys secure digital transactions?">
