...
<Callout type="warning" title="Please review before use">
  These templates are <strong>reference implementations</strong>, not ready-to-deploy production contracts or chaincode. 
  Always customize and test thoroughly before using in any live or sensitive environment.
</Callout>
