...
Every instance of the IDE contains a set of pre-built smart contract templates. These templates are easily customizable to match your specific use case. [Discover the smart contract set templates for Polygon zkEVM.](../7_Polygon-zkEVM/Template-library/1_polygon-zkevm-erc-20.md)
