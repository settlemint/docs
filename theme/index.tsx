...
function context() {
  ...
  if (!hotjar) {
    throw new Error(`Create a 'hotjar' object containing a 'siteId' property in 'themeConfig'.`);
  }

  const { siteId } = hotjar;

  if (!siteId) {
    throw new Error('Error in `themeConfig`. `hotjar` object found but `siteId` prop is missing.');
  }
      ...
      <div className={styles.container}>
        <div className={styles.twoColumn}>
          ...
          <div className={styles.twoColumnText}>
            ...
            <p>
              The SettleMint platform solves the problem of the <br /> fragmented blockchain tooling ecosystem.
            </p>
            <p>
              {' '}
              It offers a unified developer experience for building blockchain applications <br />
              through a combination of familiar and custom tools.{' '}
            </p>
            <p>
              You can host the platform on a managed cloud, your own cloud, or on-premises <br /> to meet your
              performance and security needs.
            </p>
            <p>Get started on your blockchain transformation by building your first application:</p>
            <a href="https://console.settlemint.com/documentation/docs/launch-platform/managed-cloud-deployment/quickstart/">
              <button className={styles.secondaryButton}>Build a "Hello World" Application</button>
            </a>
          </div>
        </div>
      </div>
        ...
        <div className={styles.twoColumn}>
          ...
          <div className={styles.twoColumnText}>
            <div>
              ...
              <p> </p>
              <p>
                The SettleMint Platform enables the developers to execute faster. <br /> Directly from the platform you
                can deploy:
              </p>
              <ul>
                <li>
                  Blockchain Networks including Hyperledger Besu, <br /> Polygon Edge and Ethereum
                </li>
                <li>
                  Custom smart contracts or templates <br /> like ERC-20 and ERC-721
                </li>
              ...
              <a href="https://console.settlemint.com/documentation/docs/about-settlemint/intro/">
                <button className={styles.secondaryButton}>Platform Overview</button>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="row justify-content-center align-items-center">
          <div className="col-12">
            ...
            <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
              <div style={{ textAlign: 'center' }}>
                <img className={styles.icons} src={supportIcon} alt="SettleMint Platform" style={{ width: '30%' }} />
                ...
                <a className={styles.btnLink} href="https://client.support.settlemint.com/">
                  Create a Ticket
                </a>
              </div>
              <div style={{ textAlign: 'center' }}>
                <img className={styles.icons} src={discordIcon} alt="SettleMint Platform" style={{ width: '30%' }} />
                <h3 style={{ marginTop: '0px' }}>Join Discord</h3>
                <p>Ask a question in our Discord community and chat with other users</p>
                <a className={styles.btnLink} href="https://discord.com/invite/Mt5yqFrey9">
